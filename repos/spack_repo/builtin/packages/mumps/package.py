...
class Mumps(Package):
    ...
    def write_makefile_inc(self):
        ...
        using_aocc = self.compiler.name == "aocc"
        ...
        if using_aocc or using_intel or using_oneapi or using_nvhpc or using_fj:
            # AOCC, Intel, PGI, and Fujitsu Fortran compilers provide
